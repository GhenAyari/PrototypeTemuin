...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget _buildStepItem({
    ...
    Color circleColor = isCompleted
        ? const Color(0xFF0F765E)
        : (isActive ? primaryPurple : lightPurple);
    Color textColor = isCompleted
        ? Colors.white
        : (isActive ? Colors.white : textGray);
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                '${widget.provider.rating} (124 reviews)',
                style: GoogleFonts.poppins(fontSize: 12, color: textGray),
              ),
            ],
          ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText:
              'Any specific focus areas or special requirements for the session?',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'The fluid atelier for human potential. Discover curated services that inspire growth.',
                      style: GoogleFonts.poppins(
                        color: textGray,
                        fontSize: 11,
                        height: 1.5,
          ...
          Center(
            child: Text(
              '© 2024 Temuin Inc. All rights reserved.',
              style: GoogleFonts.poppins(color: textGray, fontSize: 10),
            ),
          ),
        ],
      ),
